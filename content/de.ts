  ...
  prices: {
    ...
    columns: [
      ...
      },
      {
        name: "KI-Schulung",
        price: "CHF 1'200",
        period: "pro halben Tag",
        lead: "Dein Team arbeitet ab morgen mit KI",
        features: [
          "Ein halber Tag in deinem Betrieb",
          "Bis acht Personen",
          "Deine eigenen Beispiele und Abläufe",
          "Empfehlung, was du zuerst angehst",
        ],
        cta: { label: "Termin buchen", solid: false },
      },
    ],
